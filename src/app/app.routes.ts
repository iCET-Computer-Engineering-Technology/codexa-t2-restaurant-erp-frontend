...
export const routes: Routes = [
  ...
  { path: 'dashboard', canActivate: [roleGuard], component: Dashboard },
  {
    path: 'cashier',
    ...
    children: [
      ...
      { path: 'cashier-customer', component: Customers },
    ],
  },
  {
    path: 'manager',
    ...
    children: [
      { path: '', pathMatch: 'full', redirectTo: 'manager-dashboard' },
      { path: 'manager-dashboard', component: Dashboard },
      { path: 'admin-dashboard', pathMatch: 'full', redirectTo: 'manager-dashboard' },
      { path: 'manager-allowance', component: Allowance },
      { path: 'manager-basic-salary', component: BasicSalary },
      { path: 'manager-bonus', component: Bonus },
      { path: 'manager-deduction', component: Deduction },
      { path: 'manager-employee', component: Employee },
      { path: 'manager-employee-leave', component: EmployeeLeave },
      { path: 'manager-overtime', component: Overtime },
      { path: 'manager-payroll-config', component: PayrollConfig },
      { path: 'manager-payroll', component: Payroll },
      { path: 'manager-salary-request', component: SalaryRequest },
      { path: 'manager-salary-response', component: SalaryResponse },
    ],
  },
  {
    path: 'waiter',
  ...
  },
  {
    ...
    children: [{ path: '', component: Kitchen }],
  },
  {
    path: 'admin',
    canActivate: [roleGuard],
    ...
    children: [
      ...
      { path: 'admin-customer', component: Customers },
      { path: 'admin-order', component: OrderPlacementComponent },
      { path: 'manager-allowance', component: Allowance },
      { path: 'manager-basic-salary', component: BasicSalary },
      { path: 'manager-bonus', component: Bonus },
      { path: 'manager-deduction', component: Deduction },
      ...
      { path: 'menu-item-prices', component: MenuItemPrice },
      { path: 'menu-categories', component: MenuCategories },
      { path: 'portions', component: Portions },
      {
        ...
        children: [
          { path: 'campaigns', component: CampaignsComponent },
          {
            ...
            loadComponent: () =>
              import('./page/admin/marketing-campaign/automated-messages').then((m) => m.AutomatedMessagesComponent),
          },
