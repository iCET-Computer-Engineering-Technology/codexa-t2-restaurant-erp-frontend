...
export class ReceiptsComponent implements OnInit {
  ...
  private getReceiptCssForPrintDocument(): string {
    return `*{margin:0;padding:0;box-sizing:border-box;}body{font-family:Arial,sans-serif;font-size:11px;color:#333;line-height:1.25;background:#fff;}@page{size:A4;margin:10mm;}@media print{body{margin:0;padding:0;}.no-print{display:none !important;}}.receipt-container{width:100%;max-width:190mm;margin:0 auto;page-break-inside:avoid;display:flex;flex-direction:column;}.receipt-header{text-align:center;border-bottom:1px solid #000;padding:6px 0;margin-bottom:6px;}.receipt-header h1{font-size:16px;margin:0;font-weight:bold;letter-spacing:0.5px;}.receipt-header p{font-size:9px;margin:2px 0;}.receipt-section{margin-bottom:6px;page-break-inside:avoid;}.receipt-section-title{font-weight:bold;font-size:10px;border-bottom:1px solid #ddd;padding:3px 0;margin-bottom:4px;}.receipt-row{display:flex;justify-content:space-between;font-size:10px;padding:2px 0;margin:0;}.receipt-row.total{font-weight:bold;font-size:11px;border-top:1px solid #000;border-bottom:1px solid #000;padding:3px 0;margin:4px 0;}.receipt-row span:first-child{flex:1;}.receipt-row span:last-child{text-align:right;flex-shrink:0;}.info-grid{display:grid;grid-template-columns:1fr 1fr;gap:6px;font-size:9px;align-items:start;}.info-grid > :nth-child(2){text-align:right;justify-self:end;}.info-item{page-break-inside:avoid;}.info-label{font-weight:bold;}.info-value{margin:0;}.items-table{width:100%;border-collapse:collapse;table-layout:fixed;font-size:10px;margin:4px 0;}.items-table th{background:#f5f5f5;padding:3px 4px;font-size:9px;font-weight:bold;border-bottom:1px solid #000;}.items-table td{padding:3px 4px;border-bottom:0.5px solid #eee;vertical-align:top;}.items-table th:nth-child(1),.items-table td:nth-child(1){width:42%;text-align:left;}.items-table th:nth-child(2),.items-table td:nth-child(2){width:18%;text-align:left;}.items-table th:nth-child(3),.items-table td:nth-child(3){width:8%;text-align:center;}.items-table th:nth-child(4),.items-table td:nth-child(4){width:16%;text-align:right;white-space:nowrap;}.items-table th:nth-child(5),.items-table td:nth-child(5){width:16%;text-align:right;white-space:nowrap;}.receipt-footer{text-align:center;font-size:8px;color:#666;margin-top:8px;padding-top:6px;border-top:1px solid #ddd;display:flex;flex-direction:column;justify-content:flex-end;}`;
  }
  ...
  private getReceiptCssForInlineRender(): string {
    ...
    return `${scope},${scope} *{box-sizing:border-box;}${scope}{font-family:Arial,sans-serif;font-size:11px;color:#333;line-height:1.25;background:#fff;}${scope} .receipt-container{width:100%;max-width:190mm;margin:0 auto;display:flex;flex-direction:column;}${scope} .receipt-header{text-align:center;border-bottom:1px solid #000;padding:6px 0;margin-bottom:6px;}${scope} .receipt-header h1{font-size:16px;margin:0;font-weight:bold;letter-spacing:0.5px;}${scope} .receipt-header p{font-size:9px;margin:2px 0;}${scope} .receipt-section{margin-bottom:6px;}${scope} .receipt-section-title{font-weight:bold;font-size:10px;border-bottom:1px solid #ddd;padding:3px 0;margin-bottom:4px;}${scope} .receipt-row{display:flex;justify-content:space-between;font-size:10px;padding:2px 0;margin:0;}${scope} .receipt-row.total{font-weight:bold;font-size:11px;border-top:1px solid #000;border-bottom:1px solid #000;padding:3px 0;margin:4px 0;}${scope} .receipt-row span:first-child{flex:1;}${scope} .receipt-row span:last-child{text-align:right;flex-shrink:0;}${scope} .info-grid{display:grid;grid-template-columns:1fr 1fr;gap:6px;font-size:9px;align-items:start;}${scope} .info-grid > :nth-child(2){text-align:right;justify-self:end;}${scope} .info-label{font-weight:bold;}${scope} .info-value{margin:0;}${scope} .items-table{width:100%;border-collapse:collapse;table-layout:fixed;font-size:10px;margin:4px 0;}${scope} .items-table th{background:#f5f5f5;padding:3px 4px;font-size:9px;font-weight:bold;border-bottom:1px solid #000;}${scope} .items-table td{padding:3px 4px;border-bottom:0.5px solid #eee;vertical-align:top;}${scope} .items-table th:nth-child(1),${scope} .items-table td:nth-child(1){width:42%;text-align:left;}${scope} .items-table th:nth-child(2),${scope} .items-table td:nth-child(2){width:18%;text-align:left;}${scope} .items-table th:nth-child(3),${scope} .items-table td:nth-child(3){width:8%;text-align:center;}${scope} .items-table th:nth-child(4),${scope} .items-table td:nth-child(4){width:16%;text-align:right;white-space:nowrap;}${scope} .items-table th:nth-child(5),${scope} .items-table td:nth-child(5){width:16%;text-align:right;white-space:nowrap;}${scope} .receipt-footer{text-align:center;font-size:8px;color:#666;margin-top:8px;padding-top:6px;border-top:1px solid #ddd;display:flex;flex-direction:column;justify-content:flex-end;}`;
  }
